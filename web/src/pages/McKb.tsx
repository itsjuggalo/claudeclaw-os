      ...
      <div class="flex-1 overflow-auto px-4 py-3">
        {!dq.trim() && !data && (
          <PageState
            ...
            description={`Type a question above to query ${health?.chunks?.toLocaleString() ?? '26,000+'} chunks across the bible, your memory files, Mark Kashef's skool community, and your second-brain notes.`}
          />
        )}
        {error && (
