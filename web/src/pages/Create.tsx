// Create — generate images with the Nano Banana (Gemini) generator. Posts a
// prompt to /api/gallery/generate, which runs the local banana-maker skill and
// saves the result into the gallery's "Generated" folder, so anything made here
// also shows up on the Gallery page automatically.
...
export function Create() {
  ...
  // 512 is a Flash-only resolution; nudge Pro off it (server also coerces).
