#!/usr/bin/env node
// One-off: click-based classroom scraper for aianswers (Skool uses divs+JS, not <a href>).
// Writes to ~/mc-kb/notes/skool/aianswers-classroom/.
...
const OUT = `${process.env.HOME}/mc-kb/notes/skool/aianswers-classroom`;
...
await p.goto('https://www.skool.com/aianswers/classroom', { waitUntil: 'domcontentloaded', timeout: 60000 });
