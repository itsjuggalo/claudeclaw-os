...
const SOURCES: SourceDef[] = [
  { id: 'higgsfield', root: 'higgsfield', sub: '', title: 'Higgsfield Generations', desc: 'Images and videos generated via the Higgsfield cloud (Sora/Kling/Veo/Flux/Soul…) — newest first.', exts: ['.png', '.jpg', '.jpeg', '.webp', '.gif', '.mp4', '.webm', '.mov'], sort: 'mtime' },
  { id: 'comfyui', root: 'comfyui', sub: '', title: 'ComfyUI Generations', desc: 'Images and videos generated by ComfyUI — newest first.', exts: ['.png', '.jpg', '.jpeg', '.webp', '.gif', '.mp4', '.webm'], sort: 'mtime' },
...
export function moveGalleryFile(
  ...
  const dstFull = path.resolve(dstDir, name);
